...
// bootstrapTestRoleAccess mirrors the production composition's durable
// page-and-feature bootstrap. Journey RPCs deny missing feature rows, so the
// integration cell must carry the same authority catalog as a served cell.
