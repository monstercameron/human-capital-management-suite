...
//
// The card's short request reference (jn-journey-ref, UXLIVE-010) is inside
// these bytes deliberately: it is a business-level handle derived from the
// intent id this same card already carries unredacted in its href, so it
// discloses nothing the unauthorized view did not already show, and it is
// not part of the diagnostics disclosure this test exists to keep out.
// UXLIVE-032 moved it out of the heading into its own "Request 7D9EFG"
// line with a copy control; that control copies only the six-character
// handle already on screen, never a raw identifier, so it is not a
// diagnostics disclosure either.
func TestTodo_PROMOUX_008_Golden(t *testing.T) {
	const wantCard = `<article class="jn-card jn-journey" data-stage="AWAITING_APPROVAL"><div class="jn-journey-top"><h3><a aria-label="Promotion for Omar Reyes, Request 7D9EFG, Awaiting approval — Open request" href="/workspace/journeys/int_01JX6Y8B2C7D9EFG">Promotion for Omar Reyes</a></h3><span aria-hidden="true" class="jn-journey-status"><span class="jn-chip" data-tone="warning"><svg aria-hidden="true" class="jn-chip-icon" fill="none" focusable="false" height="18" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M10.3 4.3 2.6 17.5A2 2 0 0 0 4.3 20.5h15.4a2 2 0 0 0 1.7-3L13.7 4.3a2 2 0 0 0-3.4 0Z"></path><path d="M12 10v4"></path><path d="M12 17h.01"></path></svg>Awaiting approval</span></span></div><p class="jn-journey-refline"><span class="jn-journey-reflabel">Request</span><span class="jn-journey-ref" dir="ltr" translate="no">7D9EFG</span><button aria-label="Copy request reference 7D9EFG" class="jn-copy-btn" type="button">Copy</button></p><p class="jn-journey-headline">OPS-HRBP2 · P2 → OPS-HRBP3 · P3</p><p class="jn-journey-pay">USD 93,000.00 → 98,000.00 (+5.4%)</p><p class="jn-meta"><span class="jn-meta-item"><span class="jn-meta-key">Effective </span><span class="jn-meta-value" dir="auto">1 Jun 2026</span></span><span class="jn-meta-item"><span class="jn-meta-key">Updated </span><span class="jn-meta-value" dir="auto">12 May 2026, 09:12 UTC</span></span></p><p aria-hidden="true" class="jn-journey-foot">Open request<svg aria-hidden="true" class="jn-journey-arrow" fill="none" focusable="false" height="16" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m13 6 6 6-6 6"></path></svg></p></article>`
