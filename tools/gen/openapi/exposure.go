...
func httpExposedProcedures() []string {
	return []string{
		...
		"/hcmnext.humanwork.v1.WorkService/GetThresholdTable",
		...
		"/hcmnext.project.v1.ProjectService/AcceptProjectInvitation",
		"/hcmnext.project.v1.ProjectService/AddTaskComment",
		"/hcmnext.project.v1.ProjectService/AddTaskLink",
		"/hcmnext.project.v1.ProjectService/ArchiveTask",
		"/hcmnext.project.v1.ProjectService/ChangeProjectMemberRole",
		"/hcmnext.project.v1.ProjectService/CreateProject",
		"/hcmnext.project.v1.ProjectService/CreateTask",
		"/hcmnext.project.v1.ProjectService/DeleteTaskComment",
		"/hcmnext.project.v1.ProjectService/EditTaskComment",
		"/hcmnext.project.v1.ProjectService/GetBoard",
		"/hcmnext.project.v1.ProjectService/GetProject",
		"/hcmnext.project.v1.ProjectService/GetProjectMembership",
		"/hcmnext.project.v1.ProjectService/GetTask",
		"/hcmnext.project.v1.ProjectService/GetWorkflowConfiguration",
		"/hcmnext.project.v1.ProjectService/GetWorkflowDraft",
		"/hcmnext.project.v1.ProjectService/InviteProjectMember",
		"/hcmnext.project.v1.ProjectService/ListBoardViews",
		"/hcmnext.project.v1.ProjectService/ListProjectMembers",
		"/hcmnext.project.v1.ProjectService/ListProjects",
		"/hcmnext.project.v1.ProjectService/ListTaskActivity",
		"/hcmnext.project.v1.ProjectService/ListTaskComments",
		"/hcmnext.project.v1.ProjectService/ListTaskLinks",
		"/hcmnext.project.v1.ProjectService/ListTasks",
		"/hcmnext.project.v1.ProjectService/MoveTask",
		"/hcmnext.project.v1.ProjectService/PatchTask",
		"/hcmnext.project.v1.ProjectService/PreviewWorkflowDraft",
		"/hcmnext.project.v1.ProjectService/PublishWorkflowDraft",
		"/hcmnext.project.v1.ProjectService/RestoreTask",
		"/hcmnext.project.v1.ProjectService/RevokeProjectMember",
		"/hcmnext.project.v1.ProjectService/SaveBoardView",
		"/hcmnext.project.v1.ProjectService/SaveWorkflowDraft",
		"/hcmnext.project.v1.ProjectService/SearchTasks",
		"/hcmnext.project.v1.ProjectService/TransferProjectOwnership",
		...
		"/hcmnext.workflow.v1.WorkflowService/ClearWorkflowDraftOutcome",
		...
		"/hcmnext.workflow.v1.WorkflowService/RemoveWorkflowDraftNode",
		"/hcmnext.workflow.v1.WorkflowService/RenameWorkflowDraft",
