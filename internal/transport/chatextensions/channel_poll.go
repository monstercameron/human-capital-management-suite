...
func channelPollOut(v chat.ChannelPoll) *chatv1.ChannelPoll {
...
func (s *server) MutateChannelPoll(ctx context.Context, r *chatv1.MutateChannelPollRequest) (*chatv1.MutateChannelPollResponse, error) {
	...
	mutation := chat.ChannelPollMutation{Operation: r.GetOperation(), Question: r.GetQuestion(), Options: r.GetOptions(), OptionID: r.GetOptionId()}
