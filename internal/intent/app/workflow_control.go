...
// grant in the durable trust store, the pinned plan is resolved from the
// promotion plans this cell runs, and every control is journaled by the
// operator gateway. It returns nil controls, never an error, when the cell has
