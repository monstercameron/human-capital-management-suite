		...
		Nodes: []workflow.CompiledNode{
			{
				...
				ResolverRef:     &workflow.ResolvedReference{Kind: workflow.RefResolver, ID: "resolver:tenant", Version: "3"},
				TimeoutPolicy:   &workflow.ResolvedReference{Kind: workflow.RefTimeoutPolicy, ID: "timeout:standard", Version: "2"},
				CompensationRef: &workflow.ResolvedReference{Kind: workflow.RefCompensation, ID: "comp:salary", Version: "1"},
			},
			{ID: "decide", Type: workflow.StepDecision, Decision: &workflow.CompiledDecision{
				EvaluatorRef: "rules.band", EvaluatorVersion: 9, RuleRef: "rule:band/2026.2",
				Rule: &workflow.ResolvedReference{Kind: workflow.RefRule, ID: "rule:band", Version: "2026.2"},
			}},
			{ID: "map", Type: workflow.StepTransform, Transform: &workflow.CompiledTransform{
				TransformRef: "map.worker_to_payroll", Version: 4,
				Lookups: []workflow.TransformLookup{{Ref: "ref:grades", SnapshotDigest: "sha256:abc"}},
			}},
...
func TestDeriveNodeFingerprintReadsEveryCompiledFact(t *testing.T) {
	...
	want := map[string][]runtime.FingerprintComponent{
		"call": {
			...
			{Kind: runtime.FingerprintResolver, Ref: "resolver:tenant@3"},
			{Kind: runtime.FingerprintTimeoutPolicy, Ref: "timeout:standard@2"},
			{Kind: runtime.FingerprintCompensation, Ref: "comp:salary@1"},
		},
		"decide": {
			{Kind: runtime.FingerprintEvaluator, Ref: "rules.band@v9"},
			{Kind: runtime.FingerprintRule, Ref: "rule:band/2026.2"},
			{Kind: runtime.FingerprintRule, Ref: "rule:band@2026.2"},
		},
		"map": {
			{Kind: runtime.FingerprintMapping, Ref: "map.worker_to_payroll@v4"},
			{Kind: runtime.FingerprintReferenceData, Ref: "lookup:ref:grades@sha256:abc"},
		},
