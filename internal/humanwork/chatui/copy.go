...
var englishCopy = map[string]string{
	...
	KeySearchResults:                  "Search results for {query}",
	...
	KeyPollOptions:                    "Options, one per line",
	KeyPollOptionsHint:                "Add 2 to 10 options, one per line.",
	...
	KeyTeamWidget:                     "Channel team", KeyTeamPurpose: "Purpose", KeyTeamRole: "Channel role label", KeyTeamNote: "Channel labels are informal and do not change organization roles.", KeyChannelManager: "Channel manager", KeyChannelMember: "Channel member",
	...
	KeyPlanned: "Planned", KeyInProgress: "In progress", KeyBlocked: "Blocked", KeyDone: "Done", KeyWidgetSave: "Save", KeyWidgetAdd: "Add milestone", KeyWidgetDelete: "Delete milestone", KeyWidgetPin: "Pin widget", KeyWidgetUnpin: "Unpin widget", KeyWidgetLoading: "Loading channel widgets…", KeyWidgetError: "Could not save or load channel widgets. Refresh and try again.", KeyWidgetEmpty: "No milestones yet",
