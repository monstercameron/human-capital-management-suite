// Package gwc is the GoWebComponents server renderer for the Promotion
// workspace contract. It builds the same component tree for
...
func Stylesheet() string { return tokens.WorkspaceCSS() + layoutCSS() }
