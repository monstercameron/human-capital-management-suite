...
func peoplePersonTranslations(locale string) map[string]string {
	...
	case "ar":
		return map[string]string{
			...
			"history.all_people": "كل الموظفين", "history.person_aria": "تصفية سجل مسارات العمل حسب الموظف", "history.search_placeholder": "ابحث في السجل", "history.search_person_placeholder": "ابحث عن مسار عمل أو تغيير أو نتيجة",
