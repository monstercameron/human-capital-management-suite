...
var fixedRegisteredPages = buildRegisteredPages()
...
func buildRegisteredPages() []PageDefinition {
	return []PageDefinition{
		...
		{ID: PageHome, Route: "/workspace/app/home", Label: "Home", Icon: "home", Title: "Home", Subtitle: "Review live requests and keep your work moving.", LabelKey: "page.home.label", TitleKey: "page.home.title", SubtitleKey: "page.home.subtitle", SearchTerms: []string{"dashboard", "overview", "landing", "start"}, PrimaryNav: true, Admitted: true, NavigationPublished: true, RenderOrder: 10},
		{ID: PageMyself, Route: "/workspace/app/myself", Label: "Myself", Icon: "people", Title: "Myself", Subtitle: "Your employment, organization, payroll, and workflow information.", LabelKey: "page.myself.label", TitleKey: "page.myself.title", SubtitleKey: "page.myself.subtitle", SearchTerms: []string{"me", "my profile", "self service", "employment", "payroll", "compensation", "salary", "payslip", "personal information"}, PrimaryNav: true, Admitted: true, NavigationPublished: true, RenderOrder: 12},
		{ID: PageJourneys, Route: "/workspace/app/journeys", Label: "Journeys", Icon: "journeys", Title: "Journeys", Subtitle: "Start, follow, and complete governed employee workflows.", LabelKey: "page.journeys.label", TitleKey: "page.journeys.title", SubtitleKey: "page.journeys.subtitle", SearchTerms: []string{"workflow", "promotion", "request", "approval", "lifecycle"}, PrimaryNav: true, Admitted: true, NavigationPublished: true, RenderOrder: 15},
		{ID: PageWork, Route: "/workspace/app/work", Label: "My Work", Icon: "work", Title: "My Work", Subtitle: "Live promotion journeys that need attention.", LabelKey: "page.work.label", TitleKey: "page.work.title", SubtitleKey: "page.work.subtitle", SearchTerms: []string{"tasks", "inbox", "queue", "assigned", "pending", "approvals"}, PrimaryNav: true, Admitted: true, NavigationPublished: true, RenderOrder: 20},
		{ID: PageHistory, Route: "/workspace/app/history", Label: "Work History", Icon: "history", Title: "Workflow History", Subtitle: "Review completed, rejected, and failed workflow records.", LabelKey: "page.history.label", TitleKey: "page.history.title", SubtitleKey: "page.history.subtitle", SearchTerms: []string{"past", "completed", "rejected", "failed", "audit", "records"}, ParentNav: PageWork, Admitted: true, NavigationPublished: true, RenderOrder: 25},
		{ID: PagePeople, Route: "/workspace/app/people", Label: "People", Icon: "people", Title: "People", Subtitle: "Find employees and start the work you are authorized to manage.", LabelKey: "page.people.label", TitleKey: "page.people.title", SubtitleKey: "page.people.subtitle", SearchTerms: []string{"employees", "workers", "directory", "profiles", "staff", "team", "colleagues"}, PrimaryNav: true, Admitted: true, NavigationPublished: true, RenderOrder: 30},
		{ID: PagePerson, Route: "/workspace/app/person", Label: "Person", Icon: "people", Title: "Person profile", Subtitle: "Worker facts and available governed workflows.", LabelKey: "page.person.label", TitleKey: "page.person.title", SubtitleKey: "page.person.subtitle", SearchTerms: []string{"employee", "worker", "profile", "employment"}, RenderOrder: 35},
		{ID: PageHeadcount, Route: "/workspace/app/headcount", Label: "Headcount", Icon: "people", Title: "Headcount requests", Subtitle: "Request headcount through the governed requisition service.", LabelKey: "page.headcount.label", TitleKey: "page.headcount.title", SubtitleKey: "page.headcount.subtitle", SearchTerms: []string{"headcount", "head count", "requisition", "hiring", "open roles"}, RenderOrder: 36},
		{ID: PagePosition, Route: "/workspace/app/position", Label: "Positions", Icon: "people", Title: "Position requests", Subtitle: "Request positions through the governed position service.", LabelKey: "page.position.label", TitleKey: "page.position.title", SubtitleKey: "page.position.subtitle", SearchTerms: []string{"positions", "roles", "job requisition", "openings", "vacancies"}, RenderOrder: 37},
		{ID: PageRequisition, Route: "/workspace/app/requisition", Label: "Requisitions", Icon: "people", Title: "Requisition workspace", Subtitle: "Track requisitions through the governed requisition service.", LabelKey: "page.requisition.label", TitleKey: "page.requisition.title", SubtitleKey: "page.requisition.subtitle", SearchTerms: []string{"requisitions", "hiring workspace", "openings", "candidates", "interviews"}, RenderOrder: 38},
		{ID: PageCandidates, Route: "/workspace/app/candidates", Label: "Candidates", Icon: "people", Title: "Candidate pipeline", Subtitle: "Follow candidates through the governed candidacy service.", LabelKey: "page.candidates.label", TitleKey: "page.candidates.title", SubtitleKey: "page.candidates.subtitle", SearchTerms: []string{"candidates", "pipeline", "applicants", "interviews", "hiring"}, RenderOrder: 39},
		{ID: PageCandidate, Route: "/workspace/app/candidate", Label: "Candidate", Icon: "people", Title: "Candidate profile", Subtitle: "Candidate facts from the governed candidacy service.", LabelKey: "page.candidate.label", TitleKey: "page.candidate.title", SubtitleKey: "page.candidate.subtitle", SearchTerms: []string{"candidate", "applicant", "profile", "resume"}, RenderOrder: 40},
		{ID: PageInterviews, Route: "/workspace/app/interviews", Label: "Interviews", Icon: "people", Title: "Interview scheduling", Subtitle: "Schedule interviews through the governed scheduling service.", LabelKey: "page.interviews.label", TitleKey: "page.interviews.title", SubtitleKey: "page.interviews.subtitle", SearchTerms: []string{"interviews", "scheduling", "slots", "interviewers", "calendar"}, RenderOrder: 41},
		{ID: PageEvaluation, Route: "/workspace/app/evaluation", Label: "Evaluation", Icon: "people", Title: "Candidate evaluation", Subtitle: "Evaluate candidates through the governed evaluation service.", LabelKey: "page.evaluation.label", TitleKey: "page.evaluation.title", SubtitleKey: "page.evaluation.subtitle", SearchTerms: []string{"evaluation", "scorecard", "ratings", "feedback", "assessment"}, RenderOrder: 42},
		{ID: PageOffer, Route: "/workspace/app/offer", Label: "Offer", Icon: "people", Title: "Offer review", Subtitle: "Review offers through the governed offer service.", LabelKey: "page.offer.label", TitleKey: "page.offer.title", SubtitleKey: "page.offer.subtitle", SearchTerms: []string{"offer", "offer letter", "acceptance", "compensation", "signing"}, RenderOrder: 43},
		...
		{ID: PageOnboarding, Route: "/workspace/app/onboarding", Label: "Onboarding", Icon: "people", Title: "Onboarding plans", Subtitle: "Guide new hires through the governed onboarding service.", LabelKey: "page.onboarding.label", TitleKey: "page.onboarding.title", SubtitleKey: "page.onboarding.subtitle", SearchTerms: []string{"onboarding", "new hire", "orientation", "checklist", "first day"}, RenderOrder: 45},
		{ID: PageOnboardingTasks, Route: "/workspace/app/onboarding/tasks", Label: "Onboarding tasks", Icon: "people", Title: "Onboarding task completion", Subtitle: "Complete onboarding tasks through the governed onboarding service.", LabelKey: "page.onboarding_tasks.label", TitleKey: "page.onboarding_tasks.title", SubtitleKey: "page.onboarding_tasks.subtitle", SearchTerms: []string{"onboarding tasks", "checklist", "complete", "requirements", "due"}, RenderOrder: 46},
		{ID: PageActivationReadiness, Route: "/workspace/app/onboarding/readiness", Label: "Activation readiness", Icon: "people", Title: "Worker-activation readiness", Subtitle: "Prove workers ready to activate through the governed activation service.", LabelKey: "page.activation_readiness.label", TitleKey: "page.activation_readiness.title", SubtitleKey: "page.activation_readiness.subtitle", SearchTerms: []string{"activation", "readiness", "go-live", "start date", "clearance"}, RenderOrder: 47},
		{ID: PageTimeHub, Route: "/workspace/app/time", Label: "Time hub", Icon: "people", Title: "Employee time hub", Subtitle: "Balances, requests, and leave cases from the governed time service.", LabelKey: "page.time_hub.label", TitleKey: "page.time_hub.title", SubtitleKey: "page.time_hub.subtitle", SearchTerms: []string{"time", "balances", "time off", "leave", "requests"}, RenderOrder: 48},
		...
		{ID: PageTimeApproval, Route: "/workspace/app/time/approval", Label: "Time approval", Icon: "people", Title: "Manager time approval", Subtitle: "Approve team time through the governed time service.", LabelKey: "page.time_approval.label", TitleKey: "page.time_approval.title", SubtitleKey: "page.time_approval.subtitle", SearchTerms: []string{"approve", "team time", "requests", "timesheet", "manager"}, RenderOrder: 51},
		{ID: PageTimeExceptions, Route: "/workspace/app/time/exceptions", Label: "Time exceptions", Icon: "people", Title: "Time-exception workbench", Subtitle: "Resolve time exceptions through the governed time service.", LabelKey: "page.time_exceptions.label", TitleKey: "page.time_exceptions.title", SubtitleKey: "page.time_exceptions.subtitle", SearchTerms: []string{"exceptions", "errors", "missing", "resolve", "workbench"}, RenderOrder: 52},
		...
		{ID: PageTeamCoverage, Route: "/workspace/app/time/coverage", Label: "Team coverage", Icon: "people", Title: "Team-coverage review", Subtitle: "Review team coverage through the governed time service.", LabelKey: "page.team_coverage.label", TitleKey: "page.team_coverage.title", SubtitleKey: "page.team_coverage.subtitle", SearchTerms: []string{"coverage", "team", "absent", "review", "staffing"}, RenderOrder: 55},
		{ID: PageProtectedLeave, Route: "/workspace/app/time/protected-leave", Label: "Protected leave", Icon: "people", Title: "Protected-leave intake", Subtitle: "Start a protected leave case through the governed leave service.", LabelKey: "page.protected_leave.label", TitleKey: "page.protected_leave.title", SubtitleKey: "page.protected_leave.subtitle", SearchTerms: []string{"protected", "leave", "medical", "intake", "case"}, RenderOrder: 56},
		...
		{ID: PageLeaveTimeline, Route: "/workspace/app/time/leave-timeline", Label: "Leave timeline", Icon: "people", Title: "Leave-status timeline", Subtitle: "Follow a leave case through the governed leave service.", LabelKey: "page.leave_timeline.label", TitleKey: "page.leave_timeline.title", SubtitleKey: "page.leave_timeline.subtitle", SearchTerms: []string{"timeline", "status", "history", "case", "leave"}, RenderOrder: 58},
		{ID: PageReturnToWork, Route: "/workspace/app/time/return-to-work", Label: "Return to work", Icon: "people", Title: "Return-to-work planning", Subtitle: "Plan a return from leave through the governed leave service.", LabelKey: "page.return_to_work.label", TitleKey: "page.return_to_work.title", SubtitleKey: "page.return_to_work.subtitle", SearchTerms: []string{"return", "back to work", "plan", "recovery", "leave"}, RenderOrder: 59},

		{ID: PageOrganization, Route: "/workspace/app/organization", Label: "Organization", Icon: "organization", Title: "Organization", Subtitle: "Explore teams and reporting relationships available to you.", LabelKey: "page.organization.label", TitleKey: "page.organization.title", SubtitleKey: "page.organization.subtitle", SearchTerms: []string{"org chart", "departments", "teams", "structure", "hierarchy", "reporting"}, PrimaryNav: true, Admitted: true, NavigationPublished: true, RenderOrder: 60},
		{ID: PageInsights, Route: "/workspace/app/insights", Label: "Insights", Icon: "insights", Title: "Insights", Subtitle: "Operational counts derived from live journey states.", LabelKey: "page.insights.label", TitleKey: "page.insights.title", SubtitleKey: "page.insights.subtitle", SearchTerms: []string{"analytics", "reports", "metrics", "trends", "workforce data"}, PrimaryNav: true, Admitted: true, NavigationPublished: true, RenderOrder: 61},
		{ID: PageAdmin, Route: "/workspace/app/admin", Label: "Admin", Icon: "admin", Title: "Admin", Subtitle: "Published service capabilities and configuration availability.", LabelKey: "page.admin.label", TitleKey: "page.admin.title", SubtitleKey: "page.admin.subtitle", SearchTerms: []string{"administration", "configuration", "system", "capabilities", "manage"}, PrimaryNav: true, Admitted: true, NavigationPublished: true, RenderOrder: 62},
		{ID: PageWorkerIDs, Route: "/workspace/app/admin/worker-ids", Label: "Worker IDs", Icon: "people", Title: "Worker ID rules", Subtitle: "Configure how this organization issues unique worker numbers.", LabelKey: "page.worker_ids.label", TitleKey: "page.worker_ids.title", SubtitleKey: "page.worker_ids.subtitle", SearchTerms: []string{"worker number", "personnel number", "prefix", "sequence", "identifier", "numbering"}, ParentNav: PageAdmin, Admitted: true, NavigationPublished: true, RenderOrder: 63},
		{ID: PageRoles, Route: "/workspace/app/admin/roles", Label: "Roles & access", Icon: "admin", Title: "Roles & access", Subtitle: "Create roles and assign one or more roles across the workforce.", LabelKey: "page.roles.label", TitleKey: "page.roles.title", SubtitleKey: "page.roles.subtitle", SearchTerms: []string{"authorization", "roles", "permissions", "workforce access", "assignment", "rbac"}, ParentNav: PageAdmin, Admitted: true, NavigationPublished: true, RenderOrder: 64},
		{ID: PageOrganizationVisibility, Route: "/workspace/app/admin/organization-visibility", Label: "Organization visibility", Icon: "organization", Title: "Organization visibility", Subtitle: "Control which organization units each role can discover.", LabelKey: "page.organization_visibility.label", TitleKey: "page.organization_visibility.title", SubtitleKey: "page.organization_visibility.subtitle", SearchTerms: []string{"org chart access", "directory visibility", "role visibility", "allowlist", "denylist", "own team", "organization units"}, ParentNav: PageAdmin, Admitted: true, NavigationPublished: true, RenderOrder: 65},
		{ID: PageAppearance, Route: "/workspace/app/appearance", Label: "Brand & appearance", Icon: "palette", Title: "Brand & appearance", Subtitle: "Shape a consistent workspace identity with governed, accessible theme choices.", LabelKey: "page.appearance.label", TitleKey: "page.appearance.title", SubtitleKey: "page.appearance.subtitle", SearchTerms: []string{"branding", "theme", "colors", "logo", "dark mode", "styling", "shapes", "glyphs"}, ParentNav: PageAdmin, Admitted: true, NavigationPublished: true, RenderOrder: 66},
		{ID: PageStudio, Route: "/workspace/app/studio", Label: "Experience Studio", Icon: "studio", Title: "Experience Studio", Subtitle: "Customer page configuration requires its governed service.", LabelKey: "page.studio.label", TitleKey: "page.studio.title", SubtitleKey: "page.studio.subtitle", SearchTerms: []string{"custom pages", "layout", "builder", "designer", "experience", "configuration"}, ParentNav: PageAdmin, RenderOrder: 70},
		{ID: PageHelp, Route: "/workspace/app/help", Label: "Help", Icon: "help", Title: "Help center", Subtitle: "Guidance for the live promotion workflow.", LabelKey: "page.help.label", TitleKey: "page.help.title", SubtitleKey: "page.help.subtitle", SearchTerms: []string{"support", "guidance", "documentation", "docs", "assistance"}, Admitted: true, NavigationPublished: true, RenderOrder: 80},
		{ID: PageSettings, Route: "/workspace/app/settings", Label: "Settings", Icon: "settings", Title: "Settings", Subtitle: "Current authenticated session and available preferences.", LabelKey: "page.settings.label", TitleKey: "page.settings.title", SubtitleKey: "page.settings.subtitle", SearchTerms: []string{"preferences", "locale", "language", "accessibility", "account", "session"}, Admitted: true, NavigationPublished: true, RenderOrder: 90},
		...
		{ID: PagePaySummary, Route: "/workspace/app/pay/summary", Label: "Pay summary", Icon: "people", Title: "Employee pay summary", Subtitle: "Pay figures from the governed pay service.", LabelKey: "page.pay_summary.label", TitleKey: "page.pay_summary.title", SubtitleKey: "page.pay_summary.subtitle", SearchTerms: []string{"pay", "salary", "summary", "earnings", "wages"}, RenderOrder: 91},
		{ID: PagePayStatements, Route: "/workspace/app/pay/statements", Label: "Pay statements", Icon: "people", Title: "Accessible pay statements", Subtitle: "Statements from the governed pay service.", LabelKey: "page.pay_statements.label", TitleKey: "page.pay_statements.title", SubtitleKey: "page.pay_statements.subtitle", SearchTerms: []string{"statements", "payslip", "period", "pay", "documents"}, RenderOrder: 92},
		{ID: PagePayDiscrepancy, Route: "/workspace/app/pay/discrepancy", Label: "Pay discrepancy", Icon: "people", Title: "Pay-discrepancy intake", Subtitle: "Report a pay problem through the governed pay service.", LabelKey: "page.pay_discrepancy.label", TitleKey: "page.pay_discrepancy.title", SubtitleKey: "page.pay_discrepancy.subtitle", SearchTerms: []string{"discrepancy", "wrong pay", "report", "problem", "intake"}, RenderOrder: 93},
		{ID: PageCompProposals, Route: "/workspace/app/pay/comp-proposals", Label: "Comp proposals", Icon: "people", Title: "Manager compensation proposals", Subtitle: "Propose compensation through the governed compensation service.", LabelKey: "page.comp_proposals.label", TitleKey: "page.comp_proposals.title", SubtitleKey: "page.comp_proposals.subtitle", SearchTerms: []string{"compensation", "propose", "merit", "bonus", "manager"}, RenderOrder: 94},
		{ID: PageSalaryComparison, Route: "/workspace/app/pay/salary-comparison", Label: "Salary comparison", Icon: "people", Title: "Salary-range and budget comparison", Subtitle: "Compare ranges and budgets through the governed compensation service.", LabelKey: "page.salary_comparison.label", TitleKey: "page.salary_comparison.title", SubtitleKey: "page.salary_comparison.subtitle", SearchTerms: []string{"salary", "range", "budget", "bands", "compare"}, RenderOrder: 95},
		{ID: PageCyclePopulations, Route: "/workspace/app/pay/cycle-populations", Label: "Cycle populations", Icon: "people", Title: "Compensation-cycle populations", Subtitle: "Scope cycle populations through the governed compensation service.", LabelKey: "page.cycle_populations.label", TitleKey: "page.cycle_populations.title", SubtitleKey: "page.cycle_populations.subtitle", SearchTerms: []string{"cycle", "population", "scope", "eligibility", "compensation"}, RenderOrder: 96},
		{ID: PageCompWorksheet, Route: "/workspace/app/pay/comp-worksheet", Label: "Comp worksheet", Icon: "people", Title: "Compensation worksheet", Subtitle: "Work the cycle through the governed compensation service.", LabelKey: "page.comp_worksheet.label", TitleKey: "page.comp_worksheet.title", SubtitleKey: "page.comp_worksheet.subtitle", SearchTerms: []string{"worksheet", "cycle", "adjust", "rows", "compensation"}, RenderOrder: 97},
		{ID: PageCompCalibration, Route: "/workspace/app/pay/comp-calibration", Label: "Comp calibration", Icon: "people", Title: "Compensation calibration", Subtitle: "Calibrate awards through the governed compensation service.", LabelKey: "page.comp_calibration.label", TitleKey: "page.comp_calibration.title", SubtitleKey: "page.comp_calibration.subtitle", SearchTerms: []string{"calibration", "ratings", "awards", "session", "compensation"}, RenderOrder: 98},
		{ID: PageBenefitsOverview, Route: "/workspace/app/benefits/overview", Label: "Benefits overview", Icon: "people", Title: "Benefit-program overview", Subtitle: "Programs from the governed benefits service.", LabelKey: "page.benefits_overview.label", TitleKey: "page.benefits_overview.title", SubtitleKey: "page.benefits_overview.subtitle", SearchTerms: []string{"benefits", "programs", "overview", "enrollment", "coverage"}, RenderOrder: 99},
		...
		{ID: PageManagerCheckins, Route: "/workspace/app/growth/checkins", Label: "Manager check-ins", Icon: "people", Title: "Manager check-ins", Subtitle: "Run check-ins through the governed growth service.", LabelKey: "page.manager_checkins.label", TitleKey: "page.manager_checkins.title", SubtitleKey: "page.manager_checkins.subtitle", SearchTerms: []string{"check-ins", "one-on-one", "notes", "manager", "growth"}, RenderOrder: 106},
		{ID: PagePerfReview, Route: "/workspace/app/growth/perf-review", Label: "Perf review", Icon: "people", Title: "Performance-review workspace", Subtitle: "Review performance through the governed growth service.", LabelKey: "page.perf_review.label", TitleKey: "page.perf_review.title", SubtitleKey: "page.perf_review.subtitle", SearchTerms: []string{"performance", "review", "rating", "workspace", "growth"}, RenderOrder: 107},
		{ID: PageReviewParticipants, Route: "/workspace/app/growth/review-participants", Label: "Review participants", Icon: "people", Title: "Review-participant visibility", Subtitle: "Disclose participants through the governed growth service.", LabelKey: "page.review_participants.label", TitleKey: "page.review_participants.title", SubtitleKey: "page.review_participants.subtitle", SearchTerms: []string{"participants", "reviewer", "reviewee", "visibility", "growth"}, RenderOrder: 108},
		{ID: PageSkillsProfile, Route: "/workspace/app/growth/skills", Label: "Skills profile", Icon: "people", Title: "Governed skills profile", Subtitle: "Skills from the governed growth service.", LabelKey: "page.skills_profile.label", TitleKey: "page.skills_profile.title", SubtitleKey: "page.skills_profile.subtitle", SearchTerms: []string{"skills", "profile", "proficiency", "endorsed", "growth"}, RenderOrder: 109},
		{ID: PageAssignedLearning, Route: "/workspace/app/growth/learning", Label: "Assigned learning", Icon: "people", Title: "Assigned learning", Subtitle: "Assignments from the governed learning service.", LabelKey: "page.assigned_learning.label", TitleKey: "page.assigned_learning.title", SubtitleKey: "page.assigned_learning.subtitle", SearchTerms: []string{"learning", "assigned", "courses", "training", "growth"}, RenderOrder: 110},
		{ID: PageCareerDiscovery, Route: "/workspace/app/growth/opportunities", Label: "Career discovery", Icon: "people", Title: "Career-opportunity discovery", Subtitle: "Openings from the governed growth service.", LabelKey: "page.career_discovery.label", TitleKey: "page.career_discovery.title", SubtitleKey: "page.career_discovery.subtitle", SearchTerms: []string{"career", "opportunities", "openings", "jobs", "discover"}, RenderOrder: 111},
		{ID: PageTalentWorkbench, Route: "/workspace/app/growth/talent-workbench", Label: "Talent workbench", Icon: "people", Title: "Manager talent workbench", Subtitle: "Work team talent through the governed growth service.", LabelKey: "page.talent_workbench.label", TitleKey: "page.talent_workbench.title", SubtitleKey: "page.talent_workbench.subtitle", SearchTerms: []string{"talent", "workbench", "team", "successors", "manager"}, RenderOrder: 112},
		{ID: PageTalentCalibration, Route: "/workspace/app/growth/talent-calibration", Label: "Talent calibration", Icon: "people", Title: "Talent calibration", Subtitle: "Calibrate team talent through the governed growth service.", LabelKey: "page.talent_calibration.label", TitleKey: "page.talent_calibration.title", SubtitleKey: "page.talent_calibration.subtitle", SearchTerms: []string{"talent", "calibration", "grid", "session", "manager"}, RenderOrder: 113},
		{ID: PageSuccessionPlanning, Route: "/workspace/app/growth/succession", Label: "Succession planning", Icon: "people", Title: "Succession planning", Subtitle: "Plan succession through the governed growth service.", LabelKey: "page.succession_planning.label", TitleKey: "page.succession_planning.title", SubtitleKey: "page.succession_planning.subtitle", SearchTerms: []string{"succession", "successors", "bench", "slate", "manager"}, RenderOrder: 114},
		{ID: PageOrgExplorer, Route: "/workspace/app/organization/explorer", Label: "Org explorer", Icon: "people", Title: "Organization explorer", Subtitle: "Browse the organization through the governed organization service.", LabelKey: "page.org_explorer.label", TitleKey: "page.org_explorer.title", SubtitleKey: "page.org_explorer.subtitle", SearchTerms: []string{"organization", "explorer", "browse", "units", "chart"}, RenderOrder: 115},
		...
		{ID: PageHelpHub, Route: "/workspace/app/help/hub", Label: "Help hub", Icon: "help", Title: "Employee Help hub", Subtitle: "Reach employee help through the governed help service.", LabelKey: "page.help_hub.label", TitleKey: "page.help_hub.title", SubtitleKey: "page.help_hub.subtitle", SearchTerms: []string{"help", "hub", "support", "articles", "employee"}, RenderOrder: 127},
		{ID: PageKnowledgeSearch, Route: "/workspace/app/help/knowledge-search", Label: "Knowledge search", Icon: "help", Title: "Authorized knowledge search", Subtitle: "Search help knowledge through the governed help service.", LabelKey: "page.knowledge_search.label", TitleKey: "page.knowledge_search.title", SubtitleKey: "page.knowledge_search.subtitle", SearchTerms: []string{"knowledge", "search", "articles", "authorized", "help"}, RenderOrder: 128},
		{ID: PageHRServiceRequest, Route: "/workspace/app/help/hr-service-request", Label: "HR service request", Icon: "help", Title: "HR service-request intake", Subtitle: "Raise HR service requests through the governed help service.", LabelKey: "page.hr_service_request.label", TitleKey: "page.hr_service_request.title", SubtitleKey: "page.hr_service_request.subtitle", SearchTerms: []string{"HR", "service", "request", "intake", "help"}, RenderOrder: 129},
		{ID: PageConfidentialCase, Route: "/workspace/app/help/confidential-case", Label: "Confidential case", Icon: "help", Title: "Confidential case intake", Subtitle: "Raise confidential cases through the governed help service.", LabelKey: "page.confidential_case.label", TitleKey: "page.confidential_case.title", SubtitleKey: "page.confidential_case.subtitle", SearchTerms: []string{"confidential", "sealed", "case", "intake", "help"}, RenderOrder: 130},
		{ID: PageCaseStatus, Route: "/workspace/app/help/case-status", Label: "Case status", Icon: "help", Title: "Safe participant case status", Subtitle: "Check case status safely through the governed help service.", LabelKey: "page.case_status.label", TitleKey: "page.case_status.title", SubtitleKey: "page.case_status.subtitle", SearchTerms: []string{"case", "status", "participant", "safe", "help"}, RenderOrder: 131},
		{ID: PageCaseMessaging, Route: "/workspace/app/help/case-messaging", Label: "Case messaging", Icon: "help", Title: "Restricted case messaging", Subtitle: "Exchange case messages through the governed help service.", LabelKey: "page.case_messaging.label", TitleKey: "page.case_messaging.title", SubtitleKey: "page.case_messaging.subtitle", SearchTerms: []string{"case", "message", "restricted", "exchange", "help"}, RenderOrder: 132},
		{ID: PageCaseCenter, Route: "/workspace/app/help/case-center", Label: "Case Center", Icon: "help", Title: "Specialist Case Center", Subtitle: "Work cases as a specialist through the governed help service.", LabelKey: "page.case_center.label", TitleKey: "page.case_center.title", SubtitleKey: "page.case_center.subtitle", SearchTerms: []string{"case", "center", "specialist", "queue", "help"}, RenderOrder: 133},
		{ID: PageCaseAssignment, Route: "/workspace/app/help/case-assignment", Label: "Case assignment", Icon: "help", Title: "Case assignment and recusal", Subtitle: "Assign cases and record recusal through the governed help service.", LabelKey: "page.case_assignment.label", TitleKey: "page.case_assignment.title", SubtitleKey: "page.case_assignment.subtitle", SearchTerms: []string{"case", "assign", "recusal", "workload", "help"}, RenderOrder: 134},
		{ID: PageCaseEvidence, Route: "/workspace/app/help/case-evidence", Label: "Case evidence", Icon: "help", Title: "Restricted case evidence review", Subtitle: "Review case evidence through the governed help service.", LabelKey: "page.case_evidence.label", TitleKey: "page.case_evidence.title", SubtitleKey: "page.case_evidence.subtitle", SearchTerms: []string{"case", "evidence", "restricted", "review", "help"}, RenderOrder: 135},
		{ID: PageCaseDisposition, Route: "/workspace/app/help/case-disposition", Label: "Case disposition", Icon: "help", Title: "Case finding and disposition", Subtitle: "Record findings and disposition through the governed help service.", LabelKey: "page.case_disposition.label", TitleKey: "page.case_disposition.title", SubtitleKey: "page.case_disposition.subtitle", SearchTerms: []string{"case", "finding", "disposition", "record", "help"}, RenderOrder: 136},
		{ID: PageCaseAppeal, Route: "/workspace/app/help/case-appeal", Label: "Case appeal", Icon: "help", Title: "Case appeal", Subtitle: "Appeal case findings through the governed help service.", LabelKey: "page.case_appeal.label", TitleKey: "page.case_appeal.title", SubtitleKey: "page.case_appeal.subtitle", SearchTerms: []string{"case", "appeal", "finding", "challenge", "help"}, RenderOrder: 137},
		{ID: PageCaseRedaction, Route: "/workspace/app/help/case-redaction", Label: "Case redaction", Icon: "help", Title: "Case-view redaction and audit", Subtitle: "Prove case-view redaction and audit through the governed help service.", LabelKey: "page.case_redaction.label", TitleKey: "page.case_redaction.title", SubtitleKey: "page.case_redaction.subtitle", SearchTerms: []string{"case", "redaction", "audit", "prove", "help"}, RenderOrder: 138},
		{ID: PageExitInitiation, Route: "/workspace/app/lifecycle/exit-initiation", Label: "Exit initiation", Icon: "people", Title: "Exit initiation", Subtitle: "Start a worker exit through the governed lifecycle service.", LabelKey: "page.exit_initiation.label", TitleKey: "page.exit_initiation.title", SubtitleKey: "page.exit_initiation.subtitle", SearchTerms: []string{"exit", "initiate", "resign", "terminate", "lifecycle"}, RenderOrder: 139},
		{ID: PageExitDetails, Route: "/workspace/app/lifecycle/exit-details", Label: "Exit details", Icon: "people", Title: "Exit reason and effective date", Subtitle: "Collect the exit reason and effective date through the governed lifecycle service.", LabelKey: "page.exit_details.label", TitleKey: "page.exit_details.title", SubtitleKey: "page.exit_details.subtitle", SearchTerms: []string{"exit", "reason", "effective date", "collect", "lifecycle"}, RenderOrder: 140},
		{ID: PageOffboardingImpact, Route: "/workspace/app/lifecycle/offboarding-impact", Label: "Offboarding impact", Icon: "people", Title: "Offboarding impact simulation", Subtitle: "Simulate offboarding impact through the governed lifecycle service.", LabelKey: "page.offboarding_impact.label", TitleKey: "page.offboarding_impact.title", SubtitleKey: "page.offboarding_impact.subtitle", SearchTerms: []string{"offboarding", "impact", "simulate", "coverage", "lifecycle"}, RenderOrder: 141},
		{ID: PageExitReview, Route: "/workspace/app/lifecycle/exit-review", Label: "Exit review", Icon: "people", Title: "Exit review and approval", Subtitle: "Review and approve exits through the governed lifecycle service.", LabelKey: "page.exit_review.label", TitleKey: "page.exit_review.title", SubtitleKey: "page.exit_review.subtitle", SearchTerms: []string{"exit", "review", "approve", "authorize", "lifecycle"}, RenderOrder: 142},
		{ID: PageOffboardingPlan, Route: "/workspace/app/lifecycle/offboarding-plan", Label: "Offboarding plan", Icon: "people", Title: "Offboarding plan", Subtitle: "Plan a worker exit through the governed lifecycle service.", LabelKey: "page.offboarding_plan.label", TitleKey: "page.offboarding_plan.title", SubtitleKey: "page.offboarding_plan.subtitle", SearchTerms: []string{"offboarding", "plan", "handover", "tasks", "lifecycle"}, RenderOrder: 143},
		{ID: PageReassignmentReview, Route: "/workspace/app/lifecycle/reassignment-review", Label: "Reassignment review", Icon: "people", Title: "Manager and work reassignment review", Subtitle: "Review manager and work reassignment through the governed lifecycle service.", LabelKey: "page.reassignment_review.label", TitleKey: "page.reassignment_review.title", SubtitleKey: "page.reassignment_review.subtitle", SearchTerms: []string{"reassignment", "manager", "work", "review", "lifecycle"}, RenderOrder: 144},
		{ID: PageFinalPay, Route: "/workspace/app/lifecycle/final-pay", Label: "Final pay", Icon: "people", Title: "Final-pay and benefit status", Subtitle: "Check final pay and benefit status through the governed lifecycle service.", LabelKey: "page.final_pay.label", TitleKey: "page.final_pay.title", SubtitleKey: "page.final_pay.subtitle", SearchTerms: []string{"final pay", "benefits", "status", "check", "lifecycle"}, RenderOrder: 145},
		{ID: PageAccessEquipment, Route: "/workspace/app/lifecycle/access-equipment", Label: "Access and equipment", Icon: "people", Title: "Access and equipment reconciliation", Subtitle: "Reconcile access and equipment through the governed lifecycle service.", LabelKey: "page.access_equipment.label", TitleKey: "page.access_equipment.title", SubtitleKey: "page.access_equipment.subtitle", SearchTerms: []string{"access", "equipment", "reconcile", "badge", "lifecycle"}, RenderOrder: 146},
		{ID: PageFinalDocuments, Route: "/workspace/app/lifecycle/final-documents", Label: "Final documents", Icon: "people", Title: "Final-document delivery", Subtitle: "Receive final documents through the governed lifecycle service.", LabelKey: "page.final_documents.label", TitleKey: "page.final_documents.title", SubtitleKey: "page.final_documents.subtitle", SearchTerms: []string{"final", "documents", "delivery", "letter", "lifecycle"}, RenderOrder: 147},
		{ID: PageOffboardingEffects, Route: "/workspace/app/lifecycle/offboarding-effects", Label: "Offboarding effects", Icon: "people", Title: "Offboarding external-effect status", Subtitle: "Check offboarding external effects through the governed lifecycle service.", LabelKey: "page.offboarding_effects.label", TitleKey: "page.offboarding_effects.title", SubtitleKey: "page.offboarding_effects.subtitle", SearchTerms: []string{"offboarding", "effects", "external", "status", "lifecycle"}, RenderOrder: 148},
		{ID: PageRetainedObligations, Route: "/workspace/app/lifecycle/retained-obligations", Label: "Retained obligations", Icon: "people", Title: "Retained-obligation presentation", Subtitle: "Review retained obligations through the governed lifecycle service.", LabelKey: "page.retained_obligations.label", TitleKey: "page.retained_obligations.title", SubtitleKey: "page.retained_obligations.subtitle", SearchTerms: []string{"retained", "obligations", "non-compete", "present", "lifecycle"}, RenderOrder: 149},
		{ID: PageExitCompletion, Route: "/workspace/app/lifecycle/exit-completion", Label: "Exit completion", Icon: "people", Title: "Exit completion and correction", Subtitle: "Complete and correct exits through the governed lifecycle service.", LabelKey: "page.exit_completion.label", TitleKey: "page.exit_completion.title", SubtitleKey: "page.exit_completion.subtitle", SearchTerms: []string{"exit", "complete", "correct", "close", "lifecycle"}, RenderOrder: 150},
		{ID: PageReportCatalog, Route: "/workspace/app/reports/catalog", Label: "Report catalog", Icon: "insights", Title: "Report catalog", Subtitle: "Browse governed reports through the governed reporting service.", LabelKey: "page.report_catalog.label", TitleKey: "page.report_catalog.title", SubtitleKey: "page.report_catalog.subtitle", SearchTerms: []string{"reports", "catalog", "browse", "analytics", "intelligence"}, RenderOrder: 151},
		{ID: PageReportTypes, Route: "/workspace/app/reports/types", Label: "Report types", Icon: "insights", Title: "Certified and customer reports", Subtitle: "Distinguish certified from customer reports through the governed reporting service.", LabelKey: "page.report_types.label", TitleKey: "page.report_types.title", SubtitleKey: "page.report_types.subtitle", SearchTerms: []string{"certified", "customer", "types", "distinguish", "reports"}, RenderOrder: 152},
		{ID: PageAnalysisFloorplan, Route: "/workspace/app/reports/analysis", Label: "Analysis floorplan", Icon: "insights", Title: "Analysis floorplan", Subtitle: "Lay out governed analysis through the governed reporting service.", LabelKey: "page.analysis_floorplan.label", TitleKey: "page.analysis_floorplan.title", SubtitleKey: "page.analysis_floorplan.subtitle", SearchTerms: []string{"analysis", "floorplan", "layout", "dashboard", "reports"}, RenderOrder: 153},
		{ID: PageAnalysisFilters, Route: "/workspace/app/reports/analysis-filters", Label: "Analysis filters", Icon: "insights", Title: "Authorized analysis filters", Subtitle: "Filter governed analysis through the governed reporting service.", LabelKey: "page.analysis_filters.label", TitleKey: "page.analysis_filters.title", SubtitleKey: "page.analysis_filters.subtitle", SearchTerms: []string{"analysis", "filters", "authorized", "dimensions", "reports"}, RenderOrder: 154},
		{ID: PageResultLineage, Route: "/workspace/app/reports/result-lineage", Label: "Result lineage", Icon: "insights", Title: "Result lineage presentation", Subtitle: "Trace result lineage through the governed reporting service.", LabelKey: "page.result_lineage.label", TitleKey: "page.result_lineage.title", SubtitleKey: "page.result_lineage.subtitle", SearchTerms: []string{"lineage", "trace", "source", "present", "reports"}, RenderOrder: 155},
		{ID: PageDataFreshness, Route: "/workspace/app/reports/data-freshness", Label: "Data freshness", Icon: "insights", Title: "Data-freshness presentation", Subtitle: "Check data freshness through the governed reporting service.", LabelKey: "page.data_freshness.label", TitleKey: "page.data_freshness.title", SubtitleKey: "page.data_freshness.subtitle", SearchTerms: []string{"freshness", "stale", "lag", "present", "reports"}, RenderOrder: 156},
		{ID: PageAggregateSuppression, Route: "/workspace/app/reports/aggregate-suppression", Label: "Aggregate suppression", Icon: "insights", Title: "Aggregate suppression states", Subtitle: "Show suppression states through the governed reporting service.", LabelKey: "page.aggregate_suppression.label", TitleKey: "page.aggregate_suppression.title", SubtitleKey: "page.aggregate_suppression.subtitle", SearchTerms: []string{"suppression", "small cells", "privacy", "states", "reports"}, RenderOrder: 157},
		{ID: PageReportExport, Route: "/workspace/app/reports/export", Label: "Report export", Icon: "insights", Title: "Governed report export", Subtitle: "Export governed reports through the governed reporting service.", LabelKey: "page.report_export.label", TitleKey: "page.report_export.title", SubtitleKey: "page.report_export.subtitle", SearchTerms: []string{"export", "download", "CSV", "governed", "reports"}, RenderOrder: 158},
		{ID: PageReportSharing, Route: "/workspace/app/reports/sharing", Label: "Report sharing", Icon: "insights", Title: "Authorized report sharing", Subtitle: "Share governed reports through the governed reporting service.", LabelKey: "page.report_sharing.label", TitleKey: "page.report_sharing.title", SubtitleKey: "page.report_sharing.subtitle", SearchTerms: []string{"share", "authorized", "link", "access", "reports"}, RenderOrder: 159},
		{ID: PageNLAnalysis, Route: "/workspace/app/reports/nl-analysis", Label: "NL analysis", Icon: "insights", Title: "Safe natural-language analysis", Subtitle: "Ask governed questions through the governed reporting service.", LabelKey: "page.nl_analysis.label", TitleKey: "page.nl_analysis.title", SubtitleKey: "page.nl_analysis.subtitle", SearchTerms: []string{"questions", "plain language", "ask", "safe", "reports"}, RenderOrder: 160},
		{ID: PageAnalysisHandoff, Route: "/workspace/app/reports/analysis-handoff", Label: "Analysis handoff", Icon: "insights", Title: "Analysis-to-proposal handoff", Subtitle: "Hand analysis to proposals through the governed reporting service.", LabelKey: "page.analysis_handoff.label", TitleKey: "page.analysis_handoff.title", SubtitleKey: "page.analysis_handoff.subtitle", SearchTerms: []string{"handoff", "proposal", "analysis", "transfer", "reports"}, RenderOrder: 161},
		{ID: PageAccessibleViz, Route: "/workspace/app/reports/accessible-viz", Label: "Accessible viz", Icon: "insights", Title: "Accessible data visualization", Subtitle: "Visualize governed data through the governed reporting service.", LabelKey: "page.accessible_viz.label", TitleKey: "page.accessible_viz.title", SubtitleKey: "page.accessible_viz.subtitle", SearchTerms: []string{"visualize", "charts", "accessible", "graphs", "reports"}, RenderOrder: 162},
		{ID: PagePolicyStudio, Route: "/workspace/app/admin/policy-studio", Label: "Policy Studio", Icon: "admin", Title: "Policy Studio", Subtitle: "Author governance policy through the governed policy service.", ParentNav: PageAdmin, LabelKey: "page.policy_studio.label", TitleKey: "page.policy_studio.title", SubtitleKey: "page.policy_studio.subtitle", SearchTerms: []string{"policy", "studio", "author", "governance", "rules"}, RenderOrder: 163},
		{ID: PagePolicySimulation, Route: "/workspace/app/admin/policy-simulation", Label: "Policy simulation", Icon: "admin", Title: "Authorization-policy simulation", Subtitle: "Simulate authorization policy through the governed policy service.", ParentNav: PageAdmin, LabelKey: "page.policy_simulation.label", TitleKey: "page.policy_simulation.title", SubtitleKey: "page.policy_simulation.subtitle", SearchTerms: []string{"policy", "simulate", "authorization", "what-if", "rules"}, RenderOrder: 164},
		{ID: PageConfigurationCenter, Route: "/workspace/app/admin/configuration-center", Label: "Configuration center", Icon: "admin", Title: "Configuration center", Subtitle: "Center governed configuration through the governed configuration service.", ParentNav: PageAdmin, LabelKey: "page.configuration_center.label", TitleKey: "page.configuration_center.title", SubtitleKey: "page.configuration_center.subtitle", SearchTerms: []string{"configuration", "center", "settings", "governed", "admin"}, RenderOrder: 165},
		{ID: PageIntegrationOperations, Route: "/workspace/app/admin/integration-operations", Label: "Integration operations", Icon: "admin", Title: "Integration operations", Subtitle: "Operate governed integrations through the governed integration service.", ParentNav: PageAdmin, LabelKey: "page.integration_operations.label", TitleKey: "page.integration_operations.title", SubtitleKey: "page.integration_operations.subtitle", SearchTerms: []string{"integration", "operations", "connectors", "sync", "admin"}, RenderOrder: 166},
		{ID: PageReconciliationWorkbench, Route: "/workspace/app/admin/reconciliation-workbench", Label: "Reconciliation workbench", Icon: "admin", Title: "Reconciliation and repair workbench", Subtitle: "Reconcile and repair through the governed repair service.", ParentNav: PageAdmin, LabelKey: "page.reconciliation_workbench.label", TitleKey: "page.reconciliation_workbench.title", SubtitleKey: "page.reconciliation_workbench.subtitle", SearchTerms: []string{"reconciliation", "repair", "workbench", "breaks", "admin"}, RenderOrder: 167},
		{ID: PagePrivacyTelemetry, Route: "/workspace/app/admin/privacy-telemetry", Label: "Privacy telemetry", Icon: "admin", Title: "Privacy-safe frontend telemetry", Subtitle: "Instrument privacy-safe telemetry through the governed telemetry service.", ParentNav: PageAdmin, LabelKey: "page.privacy_telemetry.label", TitleKey: "page.privacy_telemetry.title", SubtitleKey: "page.privacy_telemetry.subtitle", SearchTerms: []string{"telemetry", "privacy", "instrument", "events", "admin"}, RenderOrder: 168},
		{ID: PagePerformanceBudgets, Route: "/workspace/app/admin/performance-budgets", Label: "Performance budgets", Icon: "admin", Title: "Frontend performance budgets", Subtitle: "Enforce frontend budgets through the governed performance service.", ParentNav: PageAdmin, LabelKey: "page.performance_budgets.label", TitleKey: "page.performance_budgets.title", SubtitleKey: "page.performance_budgets.subtitle", SearchTerms: []string{"performance", "budgets", "p95", "enforce", "admin"}, RenderOrder: 169},
		{ID: PageBrowserMatrix, Route: "/workspace/app/admin/browser-matrix", Label: "Browser matrix", Icon: "admin", Title: "Production browser matrix", Subtitle: "Qualify the browser matrix through the governed qualification service.", ParentNav: PageAdmin, LabelKey: "page.browser_matrix.label", TitleKey: "page.browser_matrix.title", SubtitleKey: "page.browser_matrix.subtitle", SearchTerms: []string{"browser", "matrix", "qualify", "support", "admin"}, RenderOrder: 170},
		{ID: PageAssistiveTech, Route: "/workspace/app/admin/assistive-tech", Label: "Assistive tech", Icon: "admin", Title: "Assistive-technology compatibility", Subtitle: "Qualify compatibility through the governed qualification service.", ParentNav: PageAdmin, LabelKey: "page.assistive_tech.label", TitleKey: "page.assistive_tech.title", SubtitleKey: "page.assistive_tech.subtitle", SearchTerms: []string{"assistive", "screen reader", "qualify", "a11y", "admin"}, RenderOrder: 171},
		{ID: PageDisasterRecovery, Route: "/workspace/app/admin/disaster-recovery", Label: "Disaster recovery", Icon: "admin", Title: "Frontend disaster recovery", Subtitle: "Prove recovery through the governed recovery service.", ParentNav: PageAdmin, LabelKey: "page.disaster_recovery.label", TitleKey: "page.disaster_recovery.title", SubtitleKey: "page.disaster_recovery.subtitle", SearchTerms: []string{"disaster", "recovery", "failover", "prove", "admin"}, RenderOrder: 172},
		{ID: PageReleaseGate, Route: "/workspace/app/admin/release-gate", Label: "Release gate", Icon: "admin", Title: "Production frontend release gate", Subtitle: "Gate the release through the governed release service.", ParentNav: PageAdmin, LabelKey: "page.release_gate.label", TitleKey: "page.release_gate.title", SubtitleKey: "page.release_gate.subtitle", SearchTerms: []string{"release", "gate", "production", "approve", "admin"}, RenderOrder: 173},
	}
}
...
func renderPage(view View) (ui.Node, error) {
	...
	render := pageRenderer(definition.ID)
	if !ok || render == nil {
...
// pageRenderer resolves a page's render function by ID. It is kept out of the
// PageDefinition data so the fixed catalogue can be initialized once at
// declaration without an initialization cycle through the render functions,
// which themselves look pages up.
func pageRenderer(id PageID) func(View) ui.Node {
	switch id {
	case PageHome:
		return homePage
	case PageMyself:
	...
	case PageOnboardingTasks:
		return onboardingTasksPage
	case PageActivationReadiness:
		return activationReadinessPage
	case PageTimeHub:
		return timeHubPage
	case PageTimeEntry:
		return timeEntryPage
	case PageTimeCorrection:
		return timeCorrectionPage
	case PageTimeApproval:
		return timeApprovalPage
	case PageTimeExceptions:
		return timeExceptionsPage
	case PageTimeOff:
		return timeOffPage
	case PageTimeOffRequest:
		return timeOffRequestPage
	case PageTeamCoverage:
		return teamCoveragePage
	case PageProtectedLeave:
		return protectedLeavePage
	case PageLeaveEvidence:
		return leaveEvidencePage
	case PageLeaveTimeline:
		return leaveTimelinePage
	case PageReturnToWork:
		return returnToWorkPage
	...
	case PageAdmin:
		return adminPage
	case PageWorkerIDs:
		return workerIDsPage
	case PageRoles:
		return rolesPage
	case PageOrganizationVisibility:
		return organizationVisibilityPage
	case PageAppearance:
	...
	case PageSettings:
		return settingsPage
	case PagePaySummary:
		return paySummaryPage
	case PagePayStatements:
		return payStatementsPage
	case PagePayDiscrepancy:
		return payDiscrepancyPage
	case PageCompProposals:
		return compProposalsPage
	case PageSalaryComparison:
		return salaryComparisonPage
	case PageCyclePopulations:
		return cyclePopulationsPage
	case PageCompWorksheet:
		return compWorksheetPage
	case PageCompCalibration:
		return compCalibrationPage
	case PageBenefitsOverview:
		return benefitsOverviewPage
	case PageBenefitsCompare:
		return benefitsComparePage
	case PageBenefitsEnroll:
		return benefitsEnrollPage
	case PagePayBenefitRecon:
		return payBenefitReconPage
	case PageGrowthHome:
		return growthHomePage
	case PageGoalPlanning:
		return goalPlanningPage
	case PageGovernedFeedback:
		return governedFeedbackPage
	case PageManagerCheckins:
		return managerCheckinsPage
	case PagePerfReview:
		return perfReviewPage
	case PageReviewParticipants:
		return reviewParticipantsPage
	case PageSkillsProfile:
		return skillsProfilePage
	case PageAssignedLearning:
		return assignedLearningPage
	case PageCareerDiscovery:
		return careerDiscoveryPage
	case PageTalentWorkbench:
		return talentWorkbenchPage
	case PageTalentCalibration:
		return talentCalibrationPage
	case PageSuccessionPlanning:
		return successionPlanningPage
	case PageOrgExplorer:
		return orgExplorerPage
	case PageOrgOutline:
		return orgOutlinePage
	case PageOrgEffectiveDate:
		return orgEffectiveDatePage
	case PagePositionObject:
		return positionObjectPage
	case PagePositionOccupancy:
		return positionOccupancyPage
	case PageHeadcountPlan:
		return headcountPlanPage
	case PageWorkforceScenario:
		return workforceScenarioPage
	case PageGovernedPopulation:
		return governedPopulationPage
	case PageCostCapacity:
		return costCapacityPage
	case PageReorgProposals:
		return reorgProposalsPage
	case PagePlannedVsCommitted:
		return plannedCommittedPage
	case PageOrgResponsive:
		return orgResponsivePage
	case PageHelpHub:
		return helpHubPage
	case PageKnowledgeSearch:
		return knowledgeSearchPage
	case PageHRServiceRequest:
		return hrServiceRequestPage
	case PageConfidentialCase:
		return confidentialCasePage
	case PageCaseStatus:
		return caseStatusPage
	case PageCaseMessaging:
		return caseMessagingPage
	case PageCaseCenter:
		return caseCenterPage
	case PageCaseAssignment:
		return caseAssignmentPage
	case PageCaseEvidence:
		return caseEvidencePage
	case PageCaseDisposition:
		return caseDispositionPage
	case PageCaseAppeal:
		return caseAppealPage
	case PageCaseRedaction:
		return caseRedactionPage
	case PageExitInitiation:
		return exitInitiationPage
	case PageExitDetails:
		return exitDetailsPage
	case PageOffboardingImpact:
		return offboardingImpactPage
	case PageExitReview:
		return exitReviewPage
	case PageOffboardingPlan:
		return offboardingPlanPage
	case PageReassignmentReview:
		return reassignmentReviewPage
	case PageFinalPay:
		return finalPayPage
	case PageAccessEquipment:
		return accessEquipmentPage
	case PageFinalDocuments:
		return finalDocumentsPage
	case PageOffboardingEffects:
		return offboardingEffectsPage
	case PageRetainedObligations:
		return retainedObligationsPage
	case PageExitCompletion:
		return exitCompletionPage
	case PageReportCatalog:
		return reportCatalogPage
	case PageReportTypes:
		return reportTypesPage
	case PageAnalysisFloorplan:
		return analysisFloorplanPage
	case PageAnalysisFilters:
		return analysisFiltersPage
	case PageResultLineage:
		return resultLineagePage
	case PageDataFreshness:
		return dataFreshnessPage
	case PageAggregateSuppression:
		return aggregateSuppressionPage
	case PageReportExport:
		return reportExportPage
	case PageReportSharing:
		return reportSharingPage
	case PageNLAnalysis:
		return nlAnalysisPage
	case PageAnalysisHandoff:
		return analysisHandoffPage
	case PageAccessibleViz:
		return accessibleVizPage
	case PagePolicyStudio:
		return policyStudioPage
	case PagePolicySimulation:
		return policySimulationPage
	case PageConfigurationCenter:
		return configurationCenterPage
	case PageIntegrationOperations:
		return integrationOperationsPage
	case PageReconciliationWorkbench:
		return reconciliationWorkbenchPage
	case PagePrivacyTelemetry:
		return privacyTelemetryPage
	case PagePerformanceBudgets:
		return performanceBudgetsPage
	case PageBrowserMatrix:
		return browserMatrixPage
	case PageAssistiveTech:
		return assistiveTechPage
	case PageDisasterRecovery:
		return disasterRecoveryPage
	case PageReleaseGate:
