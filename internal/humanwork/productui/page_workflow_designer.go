...
func workflowDesignerPage(view View) ui.Node {
	return ui.CreateElement(WorkflowDesignerPage, WorkflowDesignerPageProps{
		...
		OnClearOutcome: view.ClearWorkflowDraftOutcome,
		OnRemoveNode:   view.RemoveWorkflowDraftNode,
		OnInsertAfter:  view.InsertWorkflowStepAfter,
		OnSetOutcomes:  view.SetWorkflowDraftOutcomes,
		OnRename:       view.RenameWorkflowDraft,
