...
func TestTodo_UXAUDIT_005(t *testing.T) {
	...
	wantPrimary := []PageID{PageHome, PageMyself, PageJourneys, PageWork, PagePeople, PageOrganization, PageInsights, PageAdmin}
...
func TestTodo_UXAUDIT_005_Browser(t *testing.T) {
	...
	for _, page := range []PageID{PageWorkerIDs, PageRoles, PageOrganizationVisibility, PageAppearance} {
