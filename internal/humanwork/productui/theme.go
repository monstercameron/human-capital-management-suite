...
var registeredThemeTokens = []ThemeToken{
	...
	{Name: "size.control", CSSVariable: "--hcm-control-height", Kind: ThemeSpacing, Default: "44px", Purpose: "one height for every inline control in the header bar"},
	{Name: "radius.xs", CSSVariable: "--hcm-radius-xs", Kind: ThemeRadius, Default: "4px", Purpose: "marks and ticks too small to carry the control radius"},
	{Name: "radius.control", CSSVariable: "--hcm-radius-control", Kind: ThemeRadius, Default: "6px", CustomerOverridable: true, Purpose: "controls and compact affordances"},
	{Name: "radius.surface", CSSVariable: "--hcm-radius-surface", Kind: ThemeRadius, Default: "10px", CustomerOverridable: true, Purpose: "cards and panels"},
