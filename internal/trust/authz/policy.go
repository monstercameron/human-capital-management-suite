...
var roleEvaluationOrder = []RoleID{RoleWorkerSelf, RoleManager, RoleHRPartner, RoleCompAdmin, RoleAuditor, RoleFinancePartner}
...
var administrativeRoleOrder = []RoleID{RoleCompAdmin, RoleAuditor, RoleFinancePartner}
